...
This battery gauge is primary based on code Tanarg posted in the DCS Forums.
This code has been modified to work with the Waveshare ESP32-S3-LCD-1.28.
...
Copy the TFT_eSPI files into your libraries folder
